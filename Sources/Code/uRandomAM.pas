...
begin
  Result := Random_Normal(GeoRandom);
end;
...
begin
  Result := Random_Normal(Mean, StdDev, GeoRandom);
end;
...
begin
  Result := Random_LogNormal(Mean, StdDev, GeoRandom);
end;
...
begin
  ...
  begin
    Result := Random_Gamma(Shape, GeoRandom);
  end;
  ...
  begin
    Result := Random_ChiSq(DF, GeoRandom);
  end;
  ...
  begin
    Result := Random_Exponential(GeoRandom);
  end;
  ...
  begin
    Result := Random_Weibull(a, GeoRandom);
  end;
  ...
  begin
    Result := Random_Beta(aa, bb, GeoRandom);
  end;
  ...
  procedure Random_MVNorm(const h, d: TAMFloatVector; var f, x: TAMFloatVector;
    var ier: Integer);
  begin
    Random_MVNorm(h, d, f, x, ier, GeoRandom);
  end;
  ...
  begin
    ...
    begin
      Result := Random_Inv_Gauss(h, b, GeoRandom);
    end;
    ...
    begin
      Result := Random_Binomial1(n, p, GeoRandom);
    end;
    ...
    begin
      Result := Random_Binomial2(n, pp, GeoRandom);
    end;
    ...
    begin
      Result := Random_Neg_Binomial(sk, p, GeoRandom);
    end;
    ...
    begin
      ...
      begin
        Result := Random_von_Mises(k, GeoRandom);
      end;
      ...
      begin
        Result := Random_Cauchy(GeoRandom);
      end;
      ...
      begin
        ...
        begin
          Result := Random_Poisson(mu, GeoRandom);
        end;
